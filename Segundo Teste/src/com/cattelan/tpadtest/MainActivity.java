		...
		public boolean onTouch(View view, MotionEvent event) {
			...
			case MotionEvent.ACTION_MOVE:
				...
				if(ladoTela == 0)//caso esquerda
					...
					else if (y > posicaoInicial + distanciaBase + deltaDistancia && y < posicaoInicial + tamanhoBarra + distanciaBase + deltaDistancia
							&& x <= width/2f) 
							{
			...
			case MotionEvent.ACTION_UP:
		        ...
		        .setMessage("Em qual lado houveram dois estímulos?")
